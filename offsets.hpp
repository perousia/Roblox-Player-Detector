...
namespace Offsets {
    ...
    static constexpr uintptr_t CameraPos = 0x11C;
    ...
    static constexpr uintptr_t ChildrenEnd = 0x8;
    static constexpr uintptr_t ClassDescriptor = 0x18;
    static constexpr uintptr_t ClassDescriptorToClassName = 0x8;
    ...
    static constexpr uintptr_t DataModelToRenderView3 = 0x28;
    static constexpr uintptr_t DecalTexture = 0x198;
    static constexpr uintptr_t Deleter = 0x10;
    static constexpr uintptr_t DeleterBack = 0x18;
    ...
    static constexpr uintptr_t FogStart = 0x138;
    static constexpr uintptr_t ForceNewAFKDuration = 0x1F8;
    static constexpr uintptr_t FramePositionOffsetX = 0x524;
    static constexpr uintptr_t FramePositionOffsetY = 0x52C;
    static constexpr uintptr_t FramePositionX = 0x520;
    static constexpr uintptr_t FramePositionY = 0x528;
    static constexpr uintptr_t FrameRotation = 0x188;
    static constexpr uintptr_t FrameSizeOffsetX = 0x548;
    ...
    static constexpr uintptr_t ModuleScriptBytecodePointer = 0x10;
    ...
    static constexpr uintptr_t ProximityPromptHoldDuraction = 0x140;
    static constexpr uintptr_t ProximityPromptMaxActivationDistance = 0x148;
    static constexpr uintptr_t ProximityPromptMaxObjectText = 0xF0;
    ...
    static constexpr uintptr_t SkyboxFt = 0x150;
    static constexpr uintptr_t SkyboxLf = 0x178;
    static constexpr uintptr_t SkyboxRt = 0x1A0;
    static constexpr uintptr_t SkyboxUp = 0x1C8;
    static constexpr uintptr_t SoundId = 0xE0;
    ...
    static constexpr uintptr_t TextLabelVisible = 0x5B9;
    static constexpr uintptr_t Tool_Grip_Position = 0x454;
